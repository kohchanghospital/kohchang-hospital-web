...
export default async function ProcurementPage({
    ...
    return (
        <>
            {/* ✅ UI IMPROVED */}
            <PublicHero title={t.procurement} eyebrow="Procurement" image="/images/procurement.png" />

            {/* ✅ UI IMPROVED */}
            <section className="container-page max-w-4xl py-10 sm:py-14">
                {procurement.length === 0 ? (
                    <EmptyState title="ไม่พบข้อมูล" description="ยังไม่มีประกาศจัดซื้อจัดจ้างในขณะนี้" />
                ) : (
